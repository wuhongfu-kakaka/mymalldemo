<template>
  <div class="dialog" :style="isShow ? '': { display: 'none'}">
    <div class="dialog-mask"></div>
    <div class="dialog-core" :style="isShow ? '': { display: 'none'}">
      <div class="base-sku">
        ...
        <div class="mian-info">
          <img src="@/assets/img/cart/2.jpg_128x999.jpg" alt="" class="sku-image">
          ...
          <div class="sku-info">
            ...
            <div>
              ...
              <div class="number-calculator">
                <span class="btn-reduce disabled">-</span>
                <span class="view-value">1</span>
        ...
        <div class="comfirm-btn">
          <div class="btn-red" @click="dialogColse">确认</div>
        </div>
      </div>
    </div>
  </div>
